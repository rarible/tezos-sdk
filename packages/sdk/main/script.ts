...
export async function testScript(operation?: string, options: any = {}) {
  ...
  const config = {
    ...
    sales: "KT1DpnjHqyYKTZfRQYcYw9fx9J9qSWLwQ3ts",
    sales_storage: "KT1VcHAQ4ExqKWXtMx9iBSsqv5N3g3fF5FUS",
  ...
  const devConfig = {
    ...
    node_url: devNode,
    sales: "KT1QvxtN9oYAkrU8TDtTmT1T14N8KccySUmU",
    sales_storage: "KT1Vn8iFdCTt3RyUSDeTBoqrJSTxTPsaMXUN",
